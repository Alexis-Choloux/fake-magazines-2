                                    ...
                                    <form action="connexion.php" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" class="form-control" id="inputFirstName" required>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="inputLastName">Nom</label>
                                                <input type="password" class="form-control" id="inputLastName" required>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-warning" name="createAccount">Créer mon compte</button>
                                    </form>
                                </div>
